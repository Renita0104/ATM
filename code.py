...
class atm:
    ...
    def  _init_(self,root):
        ...
        self.root.geometry("800*760+280+0")
        self.root.configure(background='gainsboro')

        #====================================Frames==================================================
        
        MainFrame = Frame(self.root, bd=20 , width=784 , height=700, releif=RIDGE)
        MainFrame.grid()

        TopFrame1 = Frame(MainFrame, bd=7 , width=734 , height=300, releif=RIDGE)
        TopFrame1.grid(row=2 ,column=0,  padx=12)
        TopFrame2 = Frame(MainFrame, bd=7 , width=734 , height=300, releif=RIDGE)
        TopFrame2.grid(row=1 ,column=0,  padx=8)

        
        TopFrame2Left = Frame( TopFrame2, bd=5 , width=190 , height=300, releif=RIDGE)
        TopFrame2Left.grid(row=1 ,column=0,  padx=3)

        TopFrame2Mid = Frame( TopFrame2, bd=5 , width=200 , height=300, releif=RIDGE)
        TopFrame2Mid.grid(row=1 ,column=1,  padx=3)

        TopFrame2Right = Frame( TopFrame2, bd=5 , width=190 , height=300, releif=RIDGE)
        TopFrame2Right.grid(row=1 ,column=2,  padx=3)
        #=======================================Functions=============================================================
...
#===============================pin number button=================================================================
        ...
        def loan():
            enter_Pin()
            self.txtReceipt.delete("1.0",END)
            self.txtReceipt.insert(END, 'Loan L')
            self.txtReceipt.focus_set()
        ...
        def statement():
            ...
            self.txtReceipt.insert(END,'Rent  \t\t\t\t  €1200' + "\n\n")
            self.txtReceipt.insert(END,'Sainsburry' +'s \t\t\t\t €53.87'+"\n\n")
...
#==========================================================================================================
        self.imgSpl = PhotoImage(file = "empty.png")
        self.btnSpl = Button(TopFrame1, width=160,height=60,
        image=self.imgSpl).grid(row=5, column =0, padx=4,pady=4)
